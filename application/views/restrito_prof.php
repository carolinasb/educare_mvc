...
if($this->session->userdata('login') == null){
  ...
  redirect('pagina/login_professor');
}
...
<html lang="pt-br">
    ...
    <body>
        ...
        <header class="header">
            <h1>Professor</h1>
            <nav class="navegacao">
                <a target="_blank" href="<?php echo base_url('simulado'); ?>"> <i class="fa fa-plus"></i> Novo simulado </a>
                <a target="_blank" href="<?php echo base_url('cadastrarprofessor'); ?>"><i class="fa fa-plus"></i> Cadastro de Professor</a>
                <a target="_blank" href="<?php echo base_url('questao_texto'); ?>"> <i class="fa fa-plus"></i> Cadastrar questões</a>
                <a href="#portfolio"> <i class="fa fa-folder"></i> exemplo</a>
                <a href="pdfs/1.pdf" target="_blank"> <i class="fa fa-folder-open"></i>  exemplo </a>
                <a href="<?php echo base_url('logoutprof'); ?>"> Sair </a>
            </nav>
